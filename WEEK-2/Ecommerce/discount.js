...
/*
  ...
  - Check category condition (if any)
*/
export function validateCoupon(couponCode, cartTotal, cartItems) {
  ...
  if (cartTotal < coupon.minAmount) {
    return { valid: false, message: 'Minimum purchase amount not satisfied' };
  }

  if (coupon.category) {
    const validCategory = cartItems.some(
...
/*
  Apply discount and return final billing details
*/
